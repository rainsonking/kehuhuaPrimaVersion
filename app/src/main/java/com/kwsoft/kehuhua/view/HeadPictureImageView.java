...
public class HeadPictureImageView extends ImageView {
    private Paint paint;
    /**
     * 个人理解是
     *
    ...
    public HeadPictureImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public HeadPictureImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public HeadPictureImageView(Context context) {
        super(context);
        init(context, null);
    }
